...
int ReceptionistWindow::szukajDanychWPolu(std::string dana, std::string** tabela, int iloscDanych, int nrPola)
{
	for (int i = 0; i < iloscDanych; i++)
	{
...
void ReceptionistWindow::konwertujStringNaDate(string StrData, struct tm *timeinfo)	//format daty yyyy-mm-dd
...
void ReceptionistWindow::on_pushButtonClientAdd_clicked()
{
...
void ReceptionistWindow::on_pushButtonClientEdit_clicked()
{
	BazaDanych * baza;
	string** klienci = nullptr;
	string** pokoje = nullptr;
...
void ReceptionistWindow::on_pushButtonClientDelete_clicked()
{
	BazaDanych * baza;
	baza = new BazaDanych();
	int iloscDanych;
